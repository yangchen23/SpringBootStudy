...
public class EmployeeService {
     ...
     *          condition = "#a0>1 and #root.methodName eq 'aaa'" --- 多个条件
     *
     ...
     *
     * 测试步骤：
     *  1、查询1号员工；查到的结果会放到缓存中【lastName=张三,gender=1】
     ...
     *
     *  类中加 @CacheConfig(cacheNames = "emp"),相当于定义了cahe的value="emp"
     *  此时方法上的value = "emp"可以注掉
     *
     */
